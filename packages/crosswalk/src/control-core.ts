...
export const controlCore: ControlCore = {
  ...
  frameworkClauses: [
    ...
    // ISO/IEC 42001:2023 Annex A controls considered. Clauses with no mapping
    // below surface as deltas (obligations the Prahari core does not cover).
    { framework: 'iso-42001', ref: 'A.2.2', title: 'AI policy', category: 'A.2 Policies' },
    { framework: 'iso-42001', ref: 'A.2.3', title: 'Alignment of AI policy with other organizational policies', category: 'A.2 Policies' },
    { framework: 'iso-42001', ref: 'A.3.2', title: 'AI roles and responsibilities', category: 'A.3 Internal organization' },
    { framework: 'iso-42001', ref: 'A.4.2', title: 'Resource documentation', category: 'A.4 Resources' },
    { framework: 'iso-42001', ref: 'A.5.2', title: 'AI system impact assessment process', category: 'A.5 Impact assessment' },
    { framework: 'iso-42001', ref: 'A.5.4', title: 'Assessing AI system impact on individuals and groups', category: 'A.5 Impact assessment' },
    { framework: 'iso-42001', ref: 'A.5.5', title: 'Assessing societal impacts of AI systems', category: 'A.5 Impact assessment' },
    { framework: 'iso-42001', ref: 'A.6.1.2', title: 'Objectives for responsible development of AI systems', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.6.2.4', title: 'AI system verification and validation', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.6.2.5', title: 'AI system deployment', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.6.2.6', title: 'AI system operation and monitoring', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.6.2.7', title: 'AI system technical documentation', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.6.2.8', title: 'AI system recording of event logs', category: 'A.6 Life cycle' },
    { framework: 'iso-42001', ref: 'A.7.4', title: 'Quality of data for AI systems', category: 'A.7 Data' },
    { framework: 'iso-42001', ref: 'A.7.5', title: 'Data provenance', category: 'A.7 Data' },
    { framework: 'iso-42001', ref: 'A.8.2', title: 'System documentation and information for users', category: 'A.8 Information for interested parties' },
    { framework: 'iso-42001', ref: 'A.8.4', title: 'Communication of incidents', category: 'A.8 Information for interested parties' },
  ...
  mappings: [
    ...
    // ISO/IEC 42001:2023 mappings (conservative; verify against Annex A).
    { coreControlId: 'GOV-01', framework: 'iso-42001', clauseRef: 'A.2.2', relationship: 'partial', note: 'AI policy ≈ board-approved MRMF; RBI adds RMCB approval of high-risk models.' },
    { coreControlId: 'GOV-00', framework: 'iso-42001', clauseRef: 'A.3.2', relationship: 'partial', note: 'Roles/responsibilities; RBI makes the RE accountable for outcomes of all models.' },
    { coreControlId: 'GOV-02', framework: 'iso-42001', clauseRef: 'A.3.2', relationship: 'partial', note: 'Three lines of defence ≈ defined AI roles/responsibilities.' },
    { coreControlId: 'GOV-02', framework: 'iso-42001', clauseRef: 'A.4.2', relationship: 'partial', note: 'Senior management provides and documents resources for AI risk.' },
    { coreControlId: 'LIFE-01', framework: 'iso-42001', clauseRef: 'A.6.1.2', relationship: 'partial', note: 'Objectives for responsible development ≈ documented rationale/cost-benefit.' },
    { coreControlId: 'LIFE-01', framework: 'iso-42001', clauseRef: 'A.7.4', relationship: 'partial', note: 'Data-governance / data quality at design time.' },
    { coreControlId: 'LIFE-02', framework: 'iso-42001', clauseRef: 'A.6.2.4', relationship: 'partial', note: 'Verification & validation; RBI adds validator independence + 3-month RMCB SLA.' },
    { coreControlId: 'LIFE-03', framework: 'iso-42001', clauseRef: 'A.3.2', relationship: 'partial', note: 'Approval authority ≈ defined roles; RBI adds RMCB + time-boxed exceptions.' },
    { coreControlId: 'LIFE-04', framework: 'iso-42001', clauseRef: 'A.6.2.5', relationship: 'partial', note: 'Controlled deployment.' },
    { coreControlId: 'LIFE-04', framework: 'iso-42001', clauseRef: 'A.6.2.6', relationship: 'partial', note: 'Operation and monitoring of deployed AI.' },
    { coreControlId: 'LIFE-05', framework: 'iso-42001', clauseRef: 'A.6.2.6', relationship: 'partial', note: 'Change/operation control; RBI adds a material-change re-validation trigger.' },
    { coreControlId: 'LIFE-06', framework: 'iso-42001', clauseRef: 'A.6.2.6', relationship: 'partial', note: 'Operation/continuity; RBI mandates per-model fallback + orderly decommissioning.' },
    { coreControlId: 'INV-04', framework: 'iso-42001', clauseRef: 'A.6.2.7', relationship: 'partial', note: 'AI system technical documentation.' },
    { coreControlId: 'INV-04', framework: 'iso-42001', clauseRef: 'A.8.2', relationship: 'partial', note: 'System documentation and information for users.' },
    { coreControlId: 'AIR-01', framework: 'iso-42001', clauseRef: 'A.5.2', relationship: 'partial', note: 'AI system impact assessment ≈ AI scope/impact rating.' },
    { coreControlId: 'AIR-05', framework: 'iso-42001', clauseRef: 'A.6.2.4', relationship: 'partial', note: 'V&V incl. behavioural/explainability; RBI sets explicit thresholds.' },
    { coreControlId: 'AISEC-01', framework: 'iso-42001', clauseRef: 'A.6.2.8', relationship: 'partial', note: 'Event logging ≈ deployment-security evidence.' },
    { coreControlId: 'HO-01', framework: 'iso-42001', clauseRef: 'A.9.2', relationship: 'partial', note: 'Responsible use ≈ human oversight; RBI mandates an explicit kill switch.' },
